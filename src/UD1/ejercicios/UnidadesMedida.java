...
public class UnidadesMedida {
    public static void main(String[] args) {
        ...
        System.out.println("A campos de fútbol serían: " + hectareasCampoFutbol);
        System.out.println("A canchas de baloncesto serían: " + hectareasCanchabaloncesto);
        System.out.println("A pistas de tenis serían: " + hectareasPistaTenis);
        System.out.println("A parques del retiro serían: " + hectareasRetiro);
    }
}
